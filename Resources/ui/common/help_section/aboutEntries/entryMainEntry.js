...
function entryMainEntry(navGroup) {
	

var self = Titanium.UI.createWindow({
  backgroundColor:'white',
  title: 'About the Entry',
});
self.result=null;
...
var main_text = Ti.UI.createLabel({ text: "This is where you enter the exact content of the entry. You can also enter "+
											"the date and time at which the incident occured, if applicable.", 
