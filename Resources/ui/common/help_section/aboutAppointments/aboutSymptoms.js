...
function aboutSymptoms(navGroup) {
...
var main_text = Ti.UI.createLabel({ text: "In order to save an appointment, you must list at least one symptom that the "+
											"individual in question is suffering from. The symptoms page allows you to list one "+
											"symptom per line.",
