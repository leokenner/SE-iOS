...
function indexTreatments(navGroup) {
	

var self = Titanium.UI.createWindow({
	title: 'Treatments Help',
...
sectionApp.rows[0].add(Ti.UI.createLabel({ text: 'About treatments', left: 15, font: { fontWeight: 'bold', fontSize: 18, }, }));
...
sectionFeatures.rows[2].add(Ti.UI.createLabel({ text: 'About the medication and symptoms', left: 15, font: { fontWeight: 'bold', fontSize: 18, }, }));
...
table.addEventListener('click', function(e) {
	switch(e.row.children[0].text) {
		...
		case 'About goals and main activity':
			var question = require('ui/common/help_section/aboutTreatments/aboutMedicationSymptoms');
			break;
			
		case 'About dates and times':
			var question = require('ui/common/help_section/aboutTreatments/dateTime');
			break;
...
module.exports = indexTreatments;